...
static char *pass = "babu";
static char *dbname = "ondo";
...
int main(int argc, char *argv[])
{
	...
	CLIENT_INFO client_info[MAX_CLNT] = {{0,0,"","KKSARD","PASSWD"}, \
			 {0,0,"","KKSSMT","PASSWD"},  {0,0,"","KKSAVR","PASSWD"}, \
			 {0,0,"","pi","PASSWD"},  {0,0,"","babu","PASSWD"}, \
...
void * clnt_connection(void *arg)
{
	...
	while(1)
	{
		...
		sprintf(in_sql, "insert into sensing(ID,DATE,TIME,TEMPERATURE) values(null,curdate(),curtime(),%s)",pArray[1]);
